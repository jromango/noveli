...
export default function BookDetailModal({ book, isOpen, onClose, onUpdate, onRemove, onXpGained }: BookDetailModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/65 p-4 backdrop-blur-md">
      ...
      <div className="bg-cream rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-gray-300 shadow-xl">
        {/* Header */}
        <div className="flex justify-between items-center p-6 border-b border-gray-200">
          <h2 className="font-serif text-2xl font-bold text-text">Detalles del Libro</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex gap-4">
            <div className="w-24 h-36 bg-gray-300 rounded border border-gray-200 overflow-hidden flex-shrink-0">
              {book.cover ? (
                <img
                  src={book.cover}
                  alt={book.title}
            ...
            <div className="flex-1">
              <h3 className="font-serif text-xl font-bold text-text mb-1">{book.title}</h3>
              <p className="font-sans text-gray-600 mb-2">{book.author}</p>
              <div className="flex items-center gap-2">
                {getStatusIcon(status)}
                <span className="font-sans text-sm text-gray-600">{getStatusText(status)}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-4 border border-gray-200">
            <h4 className="font-serif font-semibold text-text mb-4">Progreso de Lectura</h4>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg font-sans text-text focus:outline-none focus:ring-2 focus:ring-gold focus:border-transparent"
                >
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="font-sans text-sm text-gray-600">Progreso</span>
              ...
              <button
                ...
                className="w-full px-4 py-2 bg-text text-cream rounded-lg font-sans font-medium hover:bg-gray-800 transition"
              >
                Guardar Progreso
              </button>
              ...
              <button
                ...
                className="w-full px-4 py-2 rounded-lg border border-red-300/60 bg-red-500/10 font-sans text-sm font-semibold text-red-700 transition hover:bg-red-500/20"
              >
          ...
          <div className="bg-white rounded-lg p-4 border border-gray-200">
            <div className="flex justify-between items-center mb-4">
              <h4 className="font-serif font-semibold text-text">Mis Notas</h4>
              <button
            ...
            {isEditing && (
              <div className="space-y-4">
                <textarea
                  ...
                  rows={4}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg font-sans text-text focus:outline-none focus:ring-2 focus:ring-gold focus:border-transparent resize-none"
                />
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <label className="flex items-center gap-2">
                        ...
                        />
                        <span className="font-sans text-sm text-text">Pública</span>
                      </label>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-text text-cream rounded-lg font-sans font-medium hover:bg-gray-800 transition disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    <Save size={16} />
